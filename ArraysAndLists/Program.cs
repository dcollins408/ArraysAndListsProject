    ...
    class Program
    {
        ...
        */
            ...
            for (int check = 0; check < numbers.Length; check++)
	    {
		    ...
		    {
			    evens.Add(numbers[check]);
		    }
		    else
		    {
			    odds.Add(numbers[check]);
		    }
	    }
            ...
            {
              Console.WriteLine(item + " is on the evens list");
            }
             ...
             */
	    foreach(var erry in odds)
	    {
		    Console.WriteLine(erry + " is on the odds list");
	    }
